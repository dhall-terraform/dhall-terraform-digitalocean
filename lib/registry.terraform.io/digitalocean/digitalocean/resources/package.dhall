...
, digitalocean_database_db = ./digitalocean_database_db.dhall
, digitalocean_database_firewall = ./digitalocean_database_firewall.dhall
, digitalocean_database_replica = ./digitalocean_database_replica.dhall
, digitalocean_database_user = ./digitalocean_database_user.dhall
...
, digitalocean_floating_ip_assignment =
    ./digitalocean_floating_ip_assignment.dhall
...
, digitalocean_kubernetes_node_pool = ./digitalocean_kubernetes_node_pool.dhall
, digitalocean_loadbalancer = ./digitalocean_loadbalancer.dhall
, digitalocean_project = ./digitalocean_project.dhall
, digitalocean_project_resources = ./digitalocean_project_resources.dhall
...
, digitalocean_volume_attachment = ./digitalocean_volume_attachment.dhall
